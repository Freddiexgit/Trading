...
order_by_ema_60(f"resource/{s_str}/us/us_stock_5day_10day_vol_{s_str}.csv", f"resource/{s_str}/us/us_order_by_ema_60_{s_str}.csv")
df_tickers = pd.read_csv(f"resource/{s_str}/us/us_order_by_ema_60_{s_str}.csv")
